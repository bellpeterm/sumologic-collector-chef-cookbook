...
attribute :remoteHost                 , :kind_of => String #Host name of remote machine.
...
attribute :remotePath                 , :kind_of => String #Path of the file on the remote machine that will be collected.
...
attribute :logNames                   , :kind_of => Array #List of Windows log types to collect. For example, "Security", "Application", etc.
attribute :domain                     , :kind_of => String #Windows domain from which logs will be created.
attribute :username                   , :kind_of => String #User name needed to connect to the remote machine.
attribute :password                   , :kind_of => String #Password needed to connect to the remote machine.
attribute :hosts                      , :kind_of => Array #List of hosts to collect from.
...
attribute :commands                   , :kind_of => Array #List of command-line arguments.
...
attribute :cronExpression             , :kind_of => String #Schedule for running the script. Must be a valid Quartz cron expression.
attribute :pathExpression             , :kind_of	=> String # A valid path expression of the file to collect.
